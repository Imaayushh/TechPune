...
const ProfilePage = ({ onBack, userEmail }) => {
    ...
    const renderField = (label, value, key, isLast = false, keyboardType = 'default') => (
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.additionalSettings}>
                    <TouchableOpacity style={styles.actionItem} onPress={() => handleAction("Change Password")} activeOpacity={0.85}>
                    ...
                    <TouchableOpacity style={styles.actionItem} onPress={() => handleAction("Help & Support")} activeOpacity={0.85}>
                        <View style={styles.actionLeft}>
                            <View style={styles.iconBox}>
                                <Text style={styles.blackIcon}>?</Text>
                            </View>
