...
export type SecurityPrivacyProps = {
  onBack: () => void;
};

export default function SecurityPrivacy({ onBack }: SecurityPrivacyProps) {
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.card}>
            <ToggleRow 
              icon="lock-solid" 
              title="App Lock" 
              description="Require a PIN or pattern to open the app"
              value={appLock}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.card}>
            <ToggleRow 
              ...
              value={showActiveSessions}
              onValueChange={setShowActiveSessions}
            />
            <View style={styles.divider} />
            <ToggleRow 
              icon="globe-solid" 
              title="Personalized Ads" 
              description="Receive ads tailored to your interests"
        ...
        <View style={styles.infoBox}>
          <Text style={styles.infoText}>
            Your privacy is important to us. We never share your personal data with third parties without your explicit consent.
          </Text>
        </View>
      </Animated.View>
    </ScrollView>
